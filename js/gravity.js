(function() {
  ...
  States.Score = (function(_super) {
    ...
    Score.prototype.enter = function() {
      ...
      this.highScore.value = (window.localStorage.getItem('gravity:highscore')) || 0;
      if (this.score > this.highScore.value) {
        this.highScore.value = this.score;
        this.newHighScore = true;
      }
      window.localStorage.setItem('gravity:highscore', this.highScore.value);
      return as(new Axe.Keyboard(this), function() {
        return this.onKeyUp = function(key) {
          if (key === 32) {
    ...
    Score.prototype.update = function() {
      ...
      return this.highScore.innerHTML = "" + (this.newHighScore ? "NEW" : "") + " High Score: " + this.highScore.value;
    };
